    ...
    thumbnail:{
        ...
        on:{
            ...
            var d = $(this.$el).siblings('.swiper-container-main');
                if(touchThumbs && d.length && d[0].swiper) {
                    d[0].swiper.slideTo(this.realIndex)
                }
            },
            }
    },
...
var swiperLauncher= function(mod){
    ...
    mod.each(function(){
       ...
       function  MutationObserveridden(){ 
                    ...
                    if(swiper_default.lazy && swiper_default.centeredSlides){

                        function lazyprevimg(){
                            e.find(".swiper-slide-prev .swiper-lazy-preloader ,.swiper-slide-duplicate-prev .swiper-lazy-preloader").each(function(){
...
jQuery(document).ready(function () {
    ...
    $('.swiper-container .is-lightbox').on("click",function (event) {
