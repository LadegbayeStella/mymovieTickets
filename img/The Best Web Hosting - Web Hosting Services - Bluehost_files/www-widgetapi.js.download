...
if(Tc){var wd={};Object.defineProperties(I,(wd[Symbol.hasInstance]=Uc(Object[Symbol.hasInstance]),wd))};var xd=window;yb("csi.gstatic.com");yb("googleads.g.doubleclick.net");yb("partner.googleadservices.com");yb("pubads.g.doubleclick.net");yb("securepubads.g.doubleclick.net");yb("tpc.googlesyndication.com");/*
 ...
 SPDX-License-Identifier: Apache-2.0
*/
var yd;try{new URL("s://g"),yd=!0}catch(a){yd=!1}var zd=yd;function Ad(a,b){a.removeAttribute("srcdoc");if(b instanceof Ib)b instanceof Ib&&b.constructor===Ib?b=b.i:(La(b),b="type_error:SafeUrl");else{a:if(zd){try{var c=new URL(b)}catch(d){c="https:";break a}c=c.protocol}else b:{c=document.createElement("a");try{c.href=b}catch(d){c=void 0;break b}c=-1!==[":",""].indexOf(c.protocol)?"https:":c.protocol}b="javascript:"===c?"about:invalid":b}a.src=b;for(b="allow-same-origin allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-storage-access-by-user-activation".split(" ");0<
...
function Pf(a,b,c){if(0==a.i){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.i=1;a:{var d=c,e=a.J,f=a.da;if(d instanceof Of){ug(d,Sf(e||ab,f||null,a));var g=!0}else{if(d)try{var h=!!d.$goog_Thenable}catch(l){h=!1}else h=!1;if(h)d.then(e,f,a),g=!0;else{if(Pa(d))try{var k=d.then;if("function"===typeof k){wg(d,k,e,f,a);g=!0;break a}}catch(l){f.call(a,l);g=!0;break a}g=!1}}}g||(a.v=c,a.i=b,a.l=null,vg(a),3!=b||c instanceof qg||xg(a,c))}}
...
var zg=lf;function qg(a){Ya.call(this,a)}
Wa(qg,Ya);qg.prototype.name="cancel";function J(a){de.call(this);this.v=1;this.m=[];this.s=0;this.i=[];this.j={};this.H=!!a}
...
function jn(a,b,c,d,e){a={retry:!0,onSuccess:c,onError:d,Ta:a,ea:b,Rb:!!e,headers:{},postBodyFormat:"",postBody:""};N("use_request_time_ms_header")&&(a.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(P())));return a}
...
h;if(f){f.hasOwnProperty("level")&&f.level&&(h=f.level);if(N("console_log_js_exceptions")){var k=f,l=[];l.push("Name: "+k.name);l.push("Message: "+k.message);k.hasOwnProperty("params")&&l.push("Error Params: "+JSON.stringify(k.params));k.hasOwnProperty("args")&&l.push("Error args: "+JSON.stringify(k.args));l.push("File name: "+k.fileName);l.push("Stacktrace: "+k.stack);window.console.log(l.join("\n"),k)}if(!(5<=In)){var m=void 0,q=void 0,t=f,p=g,y=fe(t),z=y.message||"Unknown Error",G=y.name||"UnknownError",
K=y.stack||t.j||"Not available";if(K.startsWith(G+": "+z)){var M=K.split("\n");M.shift();K=M.join("\n")}var O=y.lineNumber||"Not available",mb=y.fileName||"Not available",zc=K,va=0;if(t.hasOwnProperty("args")&&t.args&&t.args.length)for(var pa=0;pa<t.args.length&&!(va=En(t.args[pa],"params."+pa,p,va),500<=va);pa++);else if(t.hasOwnProperty("params")&&t.params){var X=t.params;if("object"===typeof t.params)for(q in X){if(X[q]){var ca="params."+q,da=Gn(X[q]);p[ca]=da;va+=ca.length+da.length;if(500<va)break}}else p.params=
Gn(X)}if(Ln.length)for(var W=0;W<Ln.length&&!(va=En(Ln[W],"params.context."+W,p,va),500<=va);W++);navigator.vendor&&!p.hasOwnProperty("vendor")&&(p["device.vendor"]=navigator.vendor);var S={message:z,name:G,lineNumber:O,fileName:mb,stack:zc,params:p,sampleWeight:1},Rj=Number(t.columnNumber);isNaN(Rj)||(S.lineNumber=S.lineNumber+":"+Rj);if("IGNORED"===t.level)m=0;else a:{for(var Sj=An(),Tj=u(Sj.U),Uf=Tj.next();!Uf.done;Uf=Tj.next()){var Uj=Uf.value;if(S.message&&S.message.match(Uj.Sb)){m=Uj.weight;
break a}}for(var Vj=u(Sj.S),Vf=Vj.next();!Vf.done;Vf=Vj.next()){var Wj=Vf.value;if(Wj.hb(S)){m=Wj.weight;break a}}m=1}S.sampleWeight=m;for(var Xj=u(vn),Wf=Xj.next();!Wf.done;Wf=Xj.next()){var Xf=Wf.value;if(Xf.va[S.name])for(var Yj=u(Xf.va[S.name]),Yf=Yj.next();!Yf.done;Yf=Yj.next()){var Zj=Yf.value,Ud=S.message.match(Zj.regexp);if(Ud){S.params["params.error.original"]=Ud[0];for(var Zf=Zj.groups,ak={},ac=0;ac<Zf.length;ac++)ak[Zf[ac]]=Ud[ac+1],S.params["params.error."+Zf[ac]]=Ud[ac+1];S.message=Xf.Ca(ak);
break}}}S.params||(S.params={});var bk=An();S.params["params.errorServiceSignature"]="msg="+bk.U.length+"&cb="+bk.S.length;S.params["params.serviceWorker"]="false";A.document&&A.document.querySelectorAll&&(S.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));yb("sample").constructor!==xb&&(S.params["params.fconst"]="true");var ra=S;window.yterr&&"function"===typeof window.yterr&&window.yterr(ra);if(0!==ra.sampleWeight&&!Hn.has(ra.message)){if("ERROR"===h){Bn.ca("handleError",
ra);if(N("record_app_crashed_web")&&0===Kn&&1===ra.sampleWeight)if(Kn++,N("errors_via_jspb")){var $f=new rh;F($f,1,1);if(!N("report_client_error_with_app_crash_ks")){var ck=new mh;F(ck,1,ra.message);var dk=new nh;H(dk,mh,3,ck);var ek=new oh;H(ek,nh,5,dk);var fk=new ph;H(fk,oh,9,ek);H($f,ph,4,fk)}var no=$f,gk=new uh;kd(gk,rh,20,vh,no);tn(gk)}else{var hk={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};N("report_client_error_with_app_crash_ks")||(hk.systemHealth={crashData:{clientError:{logMessage:{message:ra.message}}}});
un("appCrashed",hk)}Jn++}else"WARNING"===h&&Bn.ca("handleWarning",ra);if(N("kevlar_gel_error_routing"))a:{var ag=void 0,bg=void 0,Mc=h,Q=ra;if(N("errors_via_jspb")){if(Nn())bg=void 0;else{var bc=new jh;F(bc,1,Q.stack);Q.fileName&&F(bc,4,Q.fileName);var Ma=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==Ma.length&&(1!==Ma.length||isNaN(Number(Ma[0]))?2!==Ma.length||isNaN(Number(Ma[0]))||isNaN(Number(Ma[1]))||(F(bc,2,Number(Ma[0])),F(bc,3,Number(Ma[1]))):F(bc,2,Number(Ma[0])));var rb=
new mh;F(rb,1,Q.message);F(rb,3,Q.name);F(rb,6,Q.sampleWeight);"ERROR"===Mc?F(rb,2,2):"WARNING"===Mc?F(rb,2,1):F(rb,2,0);var cg=new kh;F(cg,1,!0);kd(cg,jh,3,lh,bc);var sb=new gh;F(sb,3,window.location.href);for(var ik=L("FEXP_EXPERIMENTS",[]),dg=0;dg<ik.length;dg++){var jk=sb,oo=ik[dg];Sc(jk);fd(jk,5).push(oo)}var eg=Gh();if(!Hh()&&eg)for(var kk=u(Object.keys(eg)),tb=kk.next();!tb.done;tb=kk.next()){var lk=tb.value,fg=new ih;F(fg,1,lk);fg.setValue(String(eg[lk]));md(sb,4,ih,fg)}var gg=Q.params;if(gg){var mk=
u(Object.keys(gg));for(tb=mk.next();!tb.done;tb=mk.next()){var nk=tb.value,hg=new ih;F(hg,1,"client."+nk);hg.setValue(String(gg[nk]));md(sb,4,ih,hg)}}var ok=L("SERVER_NAME"),pk=L("SERVER_VERSION");if(ok&&pk){var ig=new ih;F(ig,1,"server.name");ig.setValue(ok);md(sb,4,ih,ig);var jg=new ih;F(jg,1,"server.version");jg.setValue(pk);md(sb,4,ih,jg)}var Vd=new nh;H(Vd,gh,1,sb);H(Vd,kh,2,cg);H(Vd,mh,3,rb);bg=Vd}var qk=bg;if(!qk)break a;var rk=new uh;kd(rk,nh,163,vh,qk);tn(rk)}else{if(Nn())ag=void 0;else{var Nc=
{stackTrace:Q.stack};Q.fileName&&(Nc.filename=Q.fileName);var Na=Q.lineNumber&&Q.lineNumber.split?Q.lineNumber.split(":"):[];0!==Na.length&&(1!==Na.length||isNaN(Number(Na[0]))?2!==Na.length||isNaN(Number(Na[0]))||isNaN(Number(Na[1]))||(Nc.lineNumber=Number(Na[0]),Nc.columnNumber=Number(Na[1])):Nc.lineNumber=Number(Na[0]));var kg={level:"ERROR_LEVEL_UNKNOWN",message:Q.message,errorClassName:Q.name,sampleWeight:Q.sampleWeight};"ERROR"===Mc?kg.level="ERROR_LEVEL_ERROR":"WARNING"===Mc&&(kg.level="ERROR_LEVEL_WARNNING");
var po={isObfuscated:!0,browserStackInfo:Nc},cc={pageUrl:window.location.href,kvPairs:[]};L("FEXP_EXPERIMENTS")&&(cc.experimentIds=L("FEXP_EXPERIMENTS"));var lg=Gh();if(!Hh()&&lg)for(var sk=u(Object.keys(lg)),ub=sk.next();!ub.done;ub=sk.next()){var tk=ub.value;cc.kvPairs.push({key:tk,value:String(lg[tk])})}var mg=Q.params;if(mg){var uk=u(Object.keys(mg));for(ub=uk.next();!ub.done;ub=uk.next()){var vk=ub.value;cc.kvPairs.push({key:"client."+vk,value:String(mg[vk])})}}var wk=L("SERVER_NAME"),xk=L("SERVER_VERSION");
wk&&xk&&(cc.kvPairs.push({key:"server.name",value:wk}),cc.kvPairs.push({key:"server.version",value:xk}));ag={errorMetadata:cc,stackTrace:po,logMessage:kg}}var yk=ag;if(!yk)break a;un("clientError",yk)}if("ERROR"===Mc||N("errors_flush_gel_always_killswitch"))b:if(N("migrate_events_to_ts"))c:{if(N("web_fp_via_jspb")&&(rn(!0),!N("web_fp_via_jspb_and_json")))break c;rn()}else{if(N("web_fp_via_jspb")&&(rn(!0),!N("web_fp_via_jspb_and_json")))break b;rn()}}if(!N("suppress_error_204_logging")){var vb=ra,
Oc=vb.params||{},$a={urlParams:{a:"logerror",t:"jserror",type:vb.name,msg:vb.message.substr(0,250),line:vb.lineNumber,level:h,"client.name":Oc.name},postParams:{url:L("PAGE_NAME",window.location.href),file:vb.fileName},method:"POST"};Oc.version&&($a["client.version"]=Oc.version);if($a.postParams){vb.stack&&($a.postParams.stack=vb.stack);for(var zk=u(Object.keys(Oc)),ng=zk.next();!ng.done;ng=zk.next()){var Ak=ng.value;$a.postParams["client."+Ak]=Oc[Ak]}var og=Gh();if(og)for(var Bk=u(Object.keys(og)),
pg=Bk.next();!pg.done;pg=Bk.next()){var Ck=pg.value;$a.postParams[Ck]=og[Ck]}var Dk=L("SERVER_NAME"),Ek=L("SERVER_VERSION");Dk&&Ek&&($a.postParams["server.name"]=Dk,$a.postParams["server.version"]=Ek)}ri(L("ECATCHER_REPORT_HOST","")+"/error_204",$a)}try{Hn.add(ra.message)}catch(uo){}In++}}}}}else throw $b;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function io(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
